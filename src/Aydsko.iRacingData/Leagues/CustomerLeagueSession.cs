...
// This is pretty much he same as Session except
//   NEW properties:
//      LeagueName, LeagueSeasonName, EnablePitlaneCollisions, DisallowVirtualMirror,
//      (AllowedLeagues - it is commented out in Session), Image, Owner, Admin
//   CHANGED properties:
//      Weather, Cars
//   REMOVED properties:
//      SessAdmin
public class CustomerLeagueSession
{
    ...
    public CustomerLeagueSessionWeather Weather { get; set; } = default!;
    ...
    public int?[] AllowedLeagues { get; set; } = Array.Empty<int?>(); // NEW

    [JsonPropertyName("cars")]
    public Hosted.Car[] Cars { get; set; } = Array.Empty<Hosted.Car>();

    [JsonPropertyName("heat_ses_info")]
    public HeatSessionInfo HeatSessionInfo { get; set; } = default!;
