...
public class SeasonTeamStanding
{
    ...
    public SeasonTeamStandingCar[] Cars { get; set; } = null!;

    [JsonPropertyName("drivers")]
    public SeasonTeamStandingDriver[] Drivers { get; set; } = null!;
}

[JsonSerializable(typeof(SeasonTeamStanding[])), JsonSourceGenerationOptions(WriteIndented = true)]
internal partial class SeasonTeamStandingArrayContext : JsonSerializerContext
{ }
