...
public interface IDataClient
{
    ...
    /// <summary>
    /// Retrives the weather forecast for the given track and session time.
    /// </summary>
    /// <param name="url">Url recieved from <see cref="Weather"/> to season <see cref="Schedule"/>.</param>
    /// <param name="cancellationToken">A token to allow the operation to be cancelled.</param>
    /// <returns></returns>
    Task<IEnumerable<WeatherForecast>> GetWeatherForecastFromUrlAsync(string url,
